...
public class AdminCreateAccount extends JFrame implements ActionListener
{
	...
	public void actionPerformed(ActionEvent e) 
	{
        ...
        if(o==create)
        {
            ...
            String query="insert into Admin_AccDetails values('"+First_name+"','"+Last_name+"','"+User_name+"','"+Password+"','"+ConPass+"','"+Email+"')";
