...
public class CreateAccount extends JFrame implements ActionListener {
	JLabel background, username, password, Confirm_password, Email, Firstname, Lastname, usererror, passerror,
			confirmerror, emailerror, firsterror, lasterror, heading;
	...
	CreateAccount() {
		...
		setTitle("Patient Create Account");
		setSize(1920, 1080);
		setLayout(null);
		setVisible(true);
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (o == create) {
			...
			try {
				...
				String query = "insert into Patient_AccDetails values('" + First_name + "','" + Last_name + "','"
						+ User_name + "','" + Password + "','" + ConPass + "','" + Email + "')";
		...
		if (o == cancel) {
			try {
				PatientSignin signin = new PatientSignin();
				dispose();
			} catch (Exception ae) {
				System.out.print(ae);
			}
