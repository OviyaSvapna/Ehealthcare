...
public class DocCreateAccount extends JFrame implements ActionListener
{
	...
	DocCreateAccount()
	{
		...
		setTitle("Doctor Create Account");
	    setSize(1920,1080);
	    setLayout(null);
	    setVisible(true);
	...
	public void actionPerformed(ActionEvent e) 
	{
        ...
        if(o==create)
        {
            ...
            String query="insert into Doctor_AccDetails values('"+First_name+"','"+Last_name+"','"+User_name+"','"+Password+"','"+ConPass+"','"+Email+"')";
